...
EXTRA_ENEMY_DROPS = {
    Materials.SoftWood: (
        (3000, 50),  # "Exile Soldier"
        (3020, 50),  # "Large Exile Soldier"
        (3070, 20),  # "Dominula Celebrant"
        (3360, 50),  # "Ancestral Follower"
        (3361, 50),  # "Ancestral Follower"
        (4020, 50),  # "Royal Revenant"
        (4050, 50),  # "Kaiden Sellsword"
        (4120, 100),  # "Demi-Human Chief"
        (4310, 50),  # "Soldier"
        (4311, 50),  # "Godrick Soldier"
        (4312, 50),  # "Raya Lucaria Soldier"
        (4313, 50),  # "Leyndell Soldier"
        (4314, 50),  # "Radahn Soldier"
        (4315, 50),  # "Mausoleum Soldier"
        (4316, 50),  # "Haligtree Soldier"
        (4370, 20),  # "Foot Soldier"
        (4371, 20),  # "Godrick Foot Soldier"
        (4372, 20),  # "Raya Lucaria Foot Soldier"
        (4373, 20),  # "Leyndell Foot Soldier"
        (4374, 20),  # "Radahn Foot Soldier"
        (4375, 20),  # "Mausoleum Foot Soldier"
        (4376, 20),  # "Haligtree Foot Soldier"
    ),
    ...
    Materials.MetalShards: (
        ...
        (3800, 50),  # "Cleanrot Knight"
        (3950, 20),  # "Man-Serpent"
        (4320, 50),  # "Vulgar Militia"
        (4321, 50),  # "Vulgar Militia"
        (4340, 50),  # "Mad Pumpkin Head"
