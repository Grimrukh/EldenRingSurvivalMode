...
def Constructor():
    ...
    Event_19001278()
    Event_19001280()
    DisableFlagRange((19001032, 19001037))
    Event_19001020()
    Event_19001021()
    Event_19001022()
    Event_19001023()
...
def Event_15003999():
    ...
    RemoveGoodFromPlayer(item=8411, quantity=99)
    RemoveGoodFromPlayer(item=8412, quantity=99)
    RemoveGoodFromPlayer(item=8413, quantity=99)
    RemoveGoodFromPlayer(item=8414, quantity=99)
    RemoveGoodFromPlayer(item=8415, quantity=99)
    RemoveGoodFromPlayer(item=8416, quantity=99)
    RemoveGoodFromPlayer(item=8417, quantity=99)
    RemoveGoodFromPlayer(item=8418, quantity=99)
    RemoveGoodFromPlayer(item=8419, quantity=99)
    RemoveGoodFromPlayer(item=8420, quantity=99)
    RemoveGoodFromPlayer(item=8421, quantity=99)
    RemoveGoodFromPlayer(item=8422, quantity=99)
    RemoveGoodFromPlayer(item=8423, quantity=99)
    RemoveGoodFromPlayer(item=8424, quantity=99)
    RemoveGoodFromPlayer(item=8425, quantity=99)
    RemoveGoodFromPlayer(item=8426, quantity=99)
    RemoveGoodFromPlayer(item=8427, quantity=99)
    RemoveGoodFromPlayer(item=8428, quantity=99)
